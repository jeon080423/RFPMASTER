...
그 아래에 정성 평가항목 배점을 표로 정리해줘.

예시:
- **기술능력평가 90점** = 정량 20점 + 정성 70점
- **가격평가 10점**
- **70점 이상**이어야 협상 적격자로 선정
...
### Ⅳ. 과업지시서 핵심 사항
각 항목은 불릿 포인트로 작성하고, 항목명은 굵게 표시해줘. (예: **조사방법**: ... )
- 조사방법
- 사업규모 및 표본
- 조사지역
- 설문문항
